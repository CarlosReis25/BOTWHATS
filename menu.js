...
async function showMenu(client, message, cliente, phoneNumber) {
    ...
    switch (cliente.mensagem_menu) {
      ...
      case "9":
        try {
          ...
          await client.sendMessage(message.from, "Saindo do seu usuario!");
        } catch {
          console.log('======================================================================================\n'+error+'\n');
        }
        break;
      default:
        ...
        cliente.marcador_submenu = null;
        return await showMenu(client, message, cliente, phoneNumber);
    }
  }
}
